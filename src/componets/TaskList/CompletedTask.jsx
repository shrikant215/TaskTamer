...
const CompletedTask = ({ele}) => {
  return (
    <div className='bg-green-600 w-[350px] h-full p-5 rounded-2xl flex flex-col justify-between flex-shrink-0 '>
         ...
         <div className='flex justify-between m-3 '>
           <button className='bg-red-600 rounded px-4 py-1 item-center'>Completed</button>
